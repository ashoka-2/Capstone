      ...
      <div className="w-full max-w-5xl px-6 py-12 flex flex-col items-center">
        ...
        >
          <form
            ...
            className="relative flex flex-col p-3 rounded-3xl bg-[#090b12]/90 border border-white/[0.12] focus-within:border-cyan-500/50 shadow-2xl backdrop-blur-2xl transition-all duration-300"
          >
            <textarea
              rows={2}
              value={prompt}
