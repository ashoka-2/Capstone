...
export function SkeletonCard() {
  return (
    <SkeletonTheme baseColor="#1c1917" highlightColor="#292524">
      <div className="flex flex-col rounded-2xl bg-[#1c1917] border border-white/[0.06] overflow-hidden p-4 space-y-3">
